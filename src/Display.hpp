 ...
 * The Fusion3 version only supports the 4.3 inch display.
 */ 
...
const Colour orange = UTFT::fromRGB(255,95,0);
...
protected:
	...
	Colour fcolour, bcolour;					// foreground and background colors
	bool changed;
	bool visible;
